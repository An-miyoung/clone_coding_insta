# Generated by Django 3.0.14 on 2021-07-07 08:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_user_set', models.ManyToManyField(related_name='like_post_set', to=settings.AUTH_USER_MODEL)),
                ('tag_set', models.ManyToManyField(blank=True, to='insta.Tag')),
            ],
            options={
                'ordering': ['-id'],
            },
